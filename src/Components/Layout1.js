...
function Layout1() {
    ...
    const handleSubmit = (event) => {
        ...
        emailjs.send('service_0ebnbnt', 'template_0mfk3og', {
            ...
            email:`${email}`,
            message:`mobile:${mobile} constituency:${formconstituency} description:${description} ${constituencyList}  ${stateList} `
          }, 'SX2CrohSCLcTCWGWO')
            .then((response) => {
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div className="states_block">
                                    <div className="scrollable-element ">
                                        {/* {AllStates.map((allstates) => {
                                            return (
                                                <div className="allstates_list" key={allstates.Id}>
                                                    {allstates.Id} &nbsp;&nbsp;&nbsp; {allstates.Name}
                                                </div>
                                            )
                                        })} */}
                                        { countries.map((ctr) => {
                            ...
                            <div class="col-md-6">
                                <div className=" states_block2">
                                    ...
                                    //  onChange={constituencyListChange}
                                    >
                                        {states ? states.map((state) => (
